...
Public Class Create
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtName.Text.Trim() = "" Or cbCategory.Text.Trim() = "" Or txtQuantity.Text.Trim() = "" Then
        ...
        Try
            ...
            Dim query As String = "INSERT INTO items (name, category, quantity) VALUES (@name, @category, @quantity)"
